...
const SellerLogin = () => {
  ...
  return !isSeller &&(
    <form onSubmit={onSubmmitHandler} className='min-h-screen flex items-center text-sm text-gray-600'>
        <div className='flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-lg shadow-xl border border-gray-200'>
            <p className='text-2xl font-medium m-auto text-primary'>Seller<span className='text-primary'></span>Login</p>
