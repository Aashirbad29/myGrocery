...
export const AppContextProvider = ({children})=>{
    ...
    const fetchUser = async () => {
        try {
            const { data } = await axios.get('/api/user/is-auth'); // Ensure this endpoint is correct
            console.log("User Auth Response:", data); // Log the response
            ...
            setUser(null); // In case of error, reset the user
        }
    };
